...
class TestSyncModuleManager:
    ...
    async def test_get_sync_module_status_returns_list(self, mock_blink, mock_homescreen):
        """get_sync_module_status should return Syn Module status, wifi, storage status."""

        with patch("blinkpy.api.request_homescreen",
